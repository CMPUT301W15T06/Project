...
//
//	/*
//	 * Test for US04.06.01 Basic Flow 1
//	 */
//
//	// test button exists
...
//					
//		/*
//		 * Test for US04.06.01 Basic Flow 2
//		 */
//				
...
//
//		/*
//		 * Test for US04.06.01 Basic Flow 3
//		 */
//
...
//
//		/*
//		 * Test for US04.06.01 Basic Flow 4
//		 */
...
//									
//				/*
//				 * Test for US04.06.01 Basic Flow 5
//				 */
//							
...
//
//				/*
//				 * Test for US04.06.01 Basic Flow 6
//				 */
//						
...
//								
//						/*
//						 * Test for US04.06.01 Basic Flow 7
//						 */
//								
//						// get contextMenu
...
//								
//						/*
//						 * Test for US04.06.01 Basic Flow 8
//						 */
//								
...
//							@Override
//							public void run() {
//								contextMenu.performItemClick(contextMenu, 2, claimList.getAdapter().getItemId(0));
//							}
//						});
//								
//						/*
//						 * Test for US04.06.01 Basic Flow 9
//						 */
//								
//						// get ClaimantItemListActivity
//						ActivityMonitor activityMonitor11 = getInstrumentation().addMonitor(ClaimantItemDetailActivity.class.getName(),null, false);
//						final ClaimantItemDetailActivity iDetailActivity = (ClaimantItemDetailActivity) getInstrumentation().waitForMonitorWithTimeout(activityMonitor11, 10000);
//								
//						assertNotNull(iDetailActivity);
//								
//
//						// view which is expected to be present on the screen
//						final View decorView11 = iDetailActivity.getWindow().getDecorView();
//								
//						final TextView iDDate = (TextView) iDetailActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.itemDateVTextView);	
//						// check if it is on screen
//						ViewAsserts.assertOnScreen(decorView11, iDDate);
//								
//						final TextView iDCat = (TextView) iDetailActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.itemCategoryVTextView);	
//						// check if it is on screen
//						ViewAsserts.assertOnScreen(decorView11, iDCat);
//								
//						final TextView iDDes = (TextView) iDetailActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.itemDescriptionVTextView);	
//						// check if it is on screen
//						ViewAsserts.assertOnScreen(decorView11, iDDes);
//								
//						final TextView iDAmount = (TextView) iDetailActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.itemAmountVTextView);	
//						// check if it is on screen
//						ViewAsserts.assertOnScreen(decorView11, iDAmount);
//								
//						final TextView iDCurr = (TextView) iDetailActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.itemCurrencyVTextView);	
//						// check if it is on screen
//						ViewAsserts.assertOnScreen(decorView11, iDCurr);
//						
//						/*
//						 * Test for US04.06.01 Basic Flow 10
//						 */
//						
//						
//						final Button editItem = (Button) iDetailActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.editItemButton);
//						ilActivity.runOnUiThread(new Runnable() {
//							@Override
//							public void run() {
//								// click button and open next activity.
...
//						
//						/*
//						 * Test for US04.06.01 Basic Flow 11
//						 */
//						
//						ActivityMonitor activityMonitor111 = getInstrumentation().addMonitor(ClaimantEditItemActivity.class.getName(),null, false);
//						ClaimantEditItemActivity iEditActivity = (ClaimantEditItemActivity) getInstrumentation().waitForMonitorWithTimeout(activityMonitor111, 10000);
//						// next activity is opened and captured.
//						assertNotNull(iEditActivity);
//
//						// view which is expected to be present on the screen
//						final View decorView111 = iEditActivity.getWindow().getDecorView();
//						
//						EditText iDate = (EditText) iEditActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.editItemDateEditText);
//						Spinner iCat = (Spinner) iEditActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.editCategorySpinner);
//						EditText iDes = (EditText) iEditActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.editItemDescriptionEditText);
//						EditText iAmount = (EditText) iEditActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.editItemAmountEditText);
//						Spinner iCurr = (Spinner) iEditActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.editCurrencySpinner);
//						
//						// check if it is on screen
//						ViewAsserts.assertOnScreen(decorView111, iDate);
//						assertNotNull(iDate.getVisibility());
//						
//						ViewAsserts.assertOnScreen(decorView111, iCat);
//						assertNotNull(iCat.getVisibility());
//						
//						ViewAsserts.assertOnScreen(decorView111, iDes);
//						assertNotNull(iDes.getVisibility());
//						
//						ViewAsserts.assertOnScreen(decorView111, iAmount);
//						assertNotNull(iAmount.getVisibility());
//						
//						ViewAsserts.assertOnScreen(decorView111, iCurr);
