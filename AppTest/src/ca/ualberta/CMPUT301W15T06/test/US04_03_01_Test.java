...
public class US04_03_01_Test extends
	...
	public void testLayout() {
		...
		/*
		 * Test for US04.03.01 Basic Flow 4
		 */
		...
		nextActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				/*
				 * Test for US04.03.01 Basic Flow 5
				 */
				...
				/*
				 * Test for US04.03.01 Basic Flow 6
				 */
				...
				/*
				 * Test for US04.03.01 Basic Flow 7
				 */
				...
				final Spinner iCurr = (Spinner) aiActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.createCurrencySpinner);
				...
				/*
				 * Test for US04.03.01 Basic Flow 8
				 */
					
				Spinner currSpinner = (Spinner) aiActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.createItemCategorySpinner);
				assertEquals("correct category","EUR",currSpinner.getContext());
