...
import ca.ualberta.CMPUT301W15T06.ClaimantApproverInfoActivity;
...
public class US07_05_01_Test extends
	...
	public void test040101() {
		...
		nextActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				/*
				 * Test for US 07.05.01 Basic Flow 3
				 */
				a.finish();
				...
				/*
				 * Test for US 07.05.01 Basic Flow 4,5
				 */

				//click "approver and comment"
				final Button app = (Button) thirdActivity.findViewById(ca.ualberta.CMPUT301W15T06.R.id.approver_info);
