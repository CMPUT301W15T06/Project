...
public class US05_01_01_Test extends
	...
	public void testLayout() {
		...
		/*
		 * Test for US05.01.01 Basic Flow 2
		 */
		...
		/*
		 * Test for US05.01.01 Basic Flow 3
		 */
		...
		/*
		 * Test for US05.01.01 Basic Flow 4
		 */
		...
		nextActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				/*
				 * Test for US05.01.01 Basic Flow 5
				 */
				...
				// view which is expected to be present on the screen
				final View decorView111 = ilActivity.getWindow().getDecorView();
				
				
				// check if it is on screen
				ViewAsserts.assertOnScreen(decorView111, itemList);
				assertNotNull(itemList.getVisibility());
