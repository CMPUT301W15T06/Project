...
public class US01_03_01_Test extends
	...
	protected void setUp() throws Exception {
		...
		nameView = (TextView) activity
				.findViewById(R.id.nameValueClaimantClaimDetailTextView);
		beginView = (TextView) activity
				.findViewById(R.id.startDateValueClaimantClaimDetailTextView);
		endView = (TextView) activity
				.findViewById(R.id.endingDateValueClaimantClaimDetailTextView);
		...
		nextActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				nextActivity.runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						contextMenu.performItemClick(contextMenu, 0, claimList
								.getAdapter().getItemId(0));
					}
				});

				ClaimantClaimDetailActivity a = (ClaimantClaimDetailActivity) getInstrumentation()
